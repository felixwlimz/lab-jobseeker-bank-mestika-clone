                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-8">
                      ...
                      <p class="text-muted small">{{ postedJob.location }} • {{ postedJob.jobType }}</p>
                      <span 
                        class="badge" 
                        :class="postedJob.status === 'active' ? 'bg-success' : 'bg-secondary'"
                      >
                        {{ postedJob.status }}
                      </span>
                    </div>
